...
const Pill: React.FC<WithChildren> = ({children}) => (
    <span
        className="inline-flex items-center rounded-full border px-3 py-1 text-xs md:text-sm backdrop-blur-sm border-zinc-300 dark:border-zinc-700/70 bg-white/40 dark:bg-zinc-800/40">
    {children}
  </span>
);
        ...
        <div className="mx-auto max-w-6xl px-4 md:px-6">
            <div className="mb-2 md:mb-3 flex items-end justify-between gap-4">
                <div>
                    {kicker && (
                        <div
                            className="mb-1 text-xs uppercase tracking-wider text-zinc-500 dark:text-zinc-400">{kicker}</div>
                    )}
                    {title && <h2 className="text-2xl md:text-3xl font-semibold tracking-tight">{title}</h2>}
                </div>
                <div
                    className="h-px flex-1 bg-gradient-to-r from-transparent via-zinc-200 dark:via-zinc-800 to-transparent"/>
            </div>
            {children}
        </div>
    </section>
...
export default function App(): JSX.Element {
    ...
    return (
        <div
            className="min-h-dvh bg-[radial-gradient(50%_100%_at_50%_0%,rgba(120,119,198,0.12),transparent_70%),linear-gradient(to_bottom,rgba(0,0,0,0)_0%,rgba(0,0,0,0.02)_100%)] dark:bg-[radial-gradient(50%_100%_at_50%_0%,rgba(120,119,198,0.08),transparent_60%)] text-zinc-900 dark:text-zinc-100">
            <header
                className="sticky top-0 z-50 border-b border-transparent bg-white/70 dark:bg-zinc-950/60 backdrop-blur-xl supports-[backdrop-filter]:bg-white/60 dark:supports-[backdrop-filter]:bg-zinc-950/50">
    ...
    Senior Software Engineer
                  ...
                  <span className={isActive ? "text-zinc-900 dark:text-zinc-100" : "text-zinc-600 dark:text-zinc-300"}>
                    ...
                    <div className="flex items-center gap-2">
                        <a href="mailto:hello@wyodeb.io"
                           className="p-2 rounded-lg hover:bg-zinc-100 dark:hover:bg-zinc-800/60" aria-label="Email">
                        ...
                        <div className="grid gap-8 items-center">
                            <div>
                                ...
                                <p className="mt-3 max-w-2xl text-zinc-600 dark:text-zinc-300">
                                    15+ years across backend and cloud. Modernizing systems, improving performance, and
                                    shipping features that stick.
                                </p>
                        ...
                        <Card>
                            <div className="p-5">
                                ...
                                <p className="mt-2 text-sm text-zinc-600 dark:text-zinc-300">
                                    Backend-leaning full-stack engineer. I modernize systems, trim latency, and keep the
                                    codebase approachable for teams.
                                </p>
                            </div>
                        </Card>
                        <Card>
                    ...
                    <div className="grid gap-4">
                        <Card>
                            <div className="p-5 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                                <div>
                                    <div className="text-sm text-zinc-500 dark:text-zinc-400">Sep 2024 — Present ·
                                        Chișinău
                                    </div>
                                    <div className="mt-1 font-medium">We as Web · Sr. Software Engineer & Team Lead
                                    </div>
                                    <p className="mt-1 text-sm text-zinc-600 dark:text-zinc-300 max-w-2xl">
                                        Upgraded legacy Rails to latest stable (+35% perf), raised tests to ~90% (fewer
                                        incidents),
                                        reduced job failures (−70%), sped up onboard/CI via Docker refactor, and
                                        executed zero-downtime migrations.
                                    </p>
                                </div>
                        ...
                        <Card>
                            <div className="p-5 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                                <div>
                                    <div className="text-sm text-zinc-500 dark:text-zinc-400">May 2021 — Sep 2024 ·
                                        Chișinău
                                    </div>
                                    <div className="mt-1 font-medium">Teamart Outsourcing · Sr. Software Engineer</div>
                                    <p className="mt-1 text-sm text-zinc-600 dark:text-zinc-300 max-w-2xl">
                                        Built document digitization for construction; 1.5k+ docs/day, −80% manual entry,
                                        +30% OCR accuracy,
                        ...
                        <Card>
                            <div className="p-5 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                                <div>
                                    <div className="text-sm text-zinc-500 dark:text-zinc-400">Jun 2019 — May 2021 ·
                                        Chișinău
                                    </div>
                                    <div className="mt-1 font-medium">Artsintez Media · Sr. Software Engineer</div>
                                    <p className="mt-1 text-sm text-zinc-600 dark:text-zinc-300 max-w-2xl">
                                        Document systems for state institutions (100k+ records), public site with
                                        payments for ASEM (10k+ users),
                        ...
                        <Card>
                            <div className="p-5 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                                <div>
                                    <div className="text-sm text-zinc-500 dark:text-zinc-400">Sep 2018 — Jul 2019 ·
                                        Chișinău
                                    </div>
                                    <div className="mt-1 font-medium">ASEM · Software Engineer</div>
                                    <p className="mt-1 text-sm text-zinc-600 dark:text-zinc-300 max-w-2xl">
                                        Internal apps used daily by 500+ users; automated IT workflows (−60% manual ops)
                        ...
                        <Card>
                            <div className="p-5 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                                <div>
                                    <div className="text-sm text-zinc-500 dark:text-zinc-400">Jul 2017 — Mar 2018 ·
                                        Kyiv
                                    </div>
                                    <div className="mt-1 font-medium">Bitsane · Software Engineer</div>
                                    <p className="mt-1 text-sm text-zinc-600 dark:text-zinc-300 max-w-2xl">
                                        Core account logic for crypto exchange (50k+ users); automated wallet lifecycle
                                        and Advanced Cash integration.
                                    </p>
                                </div>
                                <div className="flex flex-wrap gap-2">
                        ...
                        <Card>
                            <div className="p-5 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                                <div>
                                    <div className="text-sm text-zinc-500 dark:text-zinc-400">Jul 2015 — Nov 2017 ·
                                        Chișinău
                                    </div>
                                    <div className="mt-1 font-medium">Obmen.md · Software Engineer</div>
                                    <p className="mt-1 text-sm text-zinc-600 dark:text-zinc-300 max-w-2xl">
                                        Solo-built real-time currency exchange (3k+ users). Automated rate parsing,
                                        secure payments, 99.9% uptime, 100+ tx/day.
                                    </p>
                                </div>
                                <div className="flex flex-wrap gap-2">
                        ...
                        <Card>
                            <div className="p-5 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                                <div>
                                    <div className="text-sm text-zinc-500 dark:text-zinc-400">May 2013 — Mar 2015 ·
                                        Kyiv
                                    </div>
                                    <div className="mt-1 font-medium">LLC IPS RISE · Software Engineer</div>
                                    <p className="mt-1 text-sm text-zinc-600 dark:text-zinc-300 max-w-2xl">
                                        Payment gateway APIs handling 10k+ daily tx; led partner integrations and
                                        reduced payment support load.
                                    </p>
                                </div>
                                <div className="flex flex-wrap gap-2">
                                ...
                                <div className="flex items-start justify-between">
                                    <div>
                                        ...
                                        <p className="mt-1 text-sm text-zinc-600 dark:text-zinc-300">
                                            Crysto helps connect tech talent with companies <span
                                            className="italic">anonymously</span>. It’s a solo build: API with Django
                                            REST Framework and a React 20 + Vite frontend, deployed on Hetzner.
                                        </p>
                                    </div>
                                    <a
                        ...
                        <Card>
                            <div className="p-5">
                                ...
                                <ul className="mt-2 text-sm text-zinc-600 dark:text-zinc-300 list-disc pl-5 space-y-1">
                                    ...
                                    <li>React 20 UI bootstrapped with Vite</li>
                        ...
                        <div className="p-5">
                            <div className="grid gap-5 md:grid-cols-[1fr,0.6fr] items-start">
                                ...
                                <form className="grid gap-2.5">
                                    ...
                                    />
                                    <button
                                        className="rounded-xl bg-zinc-900 dark:bg-white text-white dark:text-zinc-900 px-4 py-2 text-sm font-medium">
                                        Send
                                    </button>
                                </form>
                            </div>
